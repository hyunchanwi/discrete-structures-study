...
export const sections: StudySection[] = [
  {
    ...
    searchText: '이산구조 이산수학 비트 디지털 정보 집합 알고리즘 그래프 최단경로 암호화 비밀번호',
  ...
  },
  {
    ...
    searchText: '명제 proposition 선언문 참 거짓 진릿값 질문 명령 변수',
  ...
  },
  {
    ...
    searchText: '부정 not 논리곱 and 논리합 or xor 배타적 함축 implication 상호조건 iff',
  ...
  },
  {
    ...
    searchText: '함축 조건문 약속 충분조건 필요조건 converse inverse contrapositive 역 이 대우 동치',
  ...
  },
  {
    ...
    searchText: '진리표 truth table 복합명제 연산 우선순위 괄호 2의 n승',
  ...
  },
  {
    ...
    searchText: '자연어 번역 롤러코스터 시스템 명세 일관성 consistent 버퍼 재전송',
  ...
  },
  {
    ...
    searchText: '비트 bit boolean c java not and or xor 논리회로 게이트 조합회로',
  ...
  },
  {
    ...
    searchText: '시험 포인트 퀴즈 복습 오답 함정 기억카드',
